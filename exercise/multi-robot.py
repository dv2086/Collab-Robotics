...
class WarehouseController:
    ...
    def __init__(self):
        ...
        self.spin_client = SpinClient('/robot1/spin', 'robot1_spin_action_client')

    def spin_plan(self):
        self.spin_client.send_targets(1.5708)
...
class SpinClient(Node):
    ...
    def __init__(self, action_name='/robot1/spin', action_client_name='spin_action_client'):
        super().__init__(action_client_name)
        self._action_client = ActionClient(self, Spin, action_name)


    def get_action_client(self):
        return self._action_client

    def send_targets(self, angle):
        spin_msg = Spin.Goal()
        spin_msg.target_yaw = angle
        self._action_client.wait_for_server()
        self._action_client.send_goal_async(spin_msg, feedback_callback=self.feedback_callback)
        

    def feedback_callback(self, feedback_msg):
        feedback = feedback_msg.angular_distance_travelled
...
def main(args=None):
    ...
    warehouse_controller.spin_plan()
